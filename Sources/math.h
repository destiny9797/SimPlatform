...
static inline void
fast_cc_multiply(std::complex<float>& out, const std::complex<float> cc1, const std::complex<float> cc2)
{
...
static inline float fast_atan2f(std::complex<float> z) { return fast_atan2f(z.imag(), z.real()); }
...
static inline unsigned int quad_45deg_slicer(std::complex<float> x)
{
    return quad_45deg_slicer(x.real(), x.imag());
}

static inline unsigned int quad_0deg_slicer(std::complex<float> x)
{
...
static inline unsigned int branchless_quad_0deg_slicer(std::complex<float> x)
{
...
static inline unsigned int branchless_quad_45deg_slicer(std::complex<float> x)
{
